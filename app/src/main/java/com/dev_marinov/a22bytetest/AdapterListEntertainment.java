...
public class AdapterListEntertainment extends RecyclerView.Adapter<AdapterListEntertainment.ViewHolder> {
    ...
    public AdapterListEntertainment(Context context, ArrayList<ModelClass> arrayList, RecyclerView recyclerView) {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                ((MainActivity)context).lastVisibleItemEntertainment = getMaxPosition(lastVisibleItemPositions);
    ...
    @NonNull
    @Override
    public AdapterListEntertainment.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rv_item_list, null, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterListEntertainment.ViewHolder holder, int position) {
