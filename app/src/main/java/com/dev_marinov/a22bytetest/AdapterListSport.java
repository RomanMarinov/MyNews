...
public class AdapterListSport extends RecyclerView.Adapter<AdapterListSport.ViewHolder> {
    ...
    public AdapterListSport(Context context, ArrayList<ModelClass> arrayList, RecyclerView recyclerView) {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
               ...
               // Log.e("zzz","-lastVisibleItemPositions=" + lastVisibleItemPositions.length);
                ...
                ((MainActivity)context).lastVisibleItemSport = getMaxPosition(lastVisibleItemPositions);
    ...
    @NonNull
    @Override
    public AdapterListSport.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rv_item_list, null, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterListSport.ViewHolder holder, int position) {
