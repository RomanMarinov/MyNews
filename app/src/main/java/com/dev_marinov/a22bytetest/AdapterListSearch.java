...
public class AdapterListSearch extends RecyclerView.Adapter<AdapterListSearch.ViewHolder> {
    ...
    public AdapterListSearch(Context context, ArrayList<ModelClass> arrayList, RecyclerView recyclerView) {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                ((MainActivity)context).lastVisibleItemSearch = getMaxPosition(lastVisibleItemPositions);
...
//        Log.e("adapter","-arrayList.get(position).getAuthor()-" + arrayList.get(position).getAuthor());
