...
public class AdapterListScience extends RecyclerView.Adapter<AdapterListScience.ViewHolder> {
    ...
    public AdapterListScience(Context context, ArrayList<ModelClass> arrayList, RecyclerView recyclerView) {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
               ...
               // Log.e("zzz","-lastVisibleItemPositions=" + lastVisibleItemPositions.length);
                ...
                ((MainActivity)context).lastVisibleItemScience = getMaxPosition(lastVisibleItemPositions);
    ...
    @NonNull
    @Override
    public AdapterListScience.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rv_item_list, null, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterListScience.ViewHolder holder, int position) {
