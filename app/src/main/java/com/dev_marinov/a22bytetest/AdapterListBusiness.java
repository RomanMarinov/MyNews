...
public class AdapterListBusiness extends RecyclerView.Adapter<AdapterListBusiness.ViewHolder> {
    ...
    public AdapterListBusiness(Context context, ArrayList<ModelClass> arrayList, RecyclerView recyclerView) {
    ...
    @NonNull
    @Override
    public AdapterListBusiness.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rv_item_list, null, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterListBusiness.ViewHolder holder, int position) {
