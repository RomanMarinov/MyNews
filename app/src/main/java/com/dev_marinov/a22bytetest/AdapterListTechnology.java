...
public class AdapterListTechnology extends RecyclerView.Adapter<AdapterListTechnology.ViewHolder> {
    ...
    public AdapterListTechnology(Context context, ArrayList<ModelClass> arrayList, RecyclerView recyclerView) {
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
               ...
               // Log.e("zzz","-lastVisibleItemPositions=" + lastVisibleItemPositions.length);
                ...
                ((MainActivity)context).lastVisibleItemTechnology = getMaxPosition(lastVisibleItemPositions);
    ...
    @NonNull
    @Override
    public AdapterListTechnology.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.rv_item_list, null, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterListTechnology.ViewHolder holder, int position) {
